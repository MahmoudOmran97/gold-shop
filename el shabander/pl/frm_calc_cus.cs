...
{
    public partial class frm_calc_cus : Form
    {
        ...
        {
            var r2 = db.tb_cus.Select(x => x.cus_name).ToList();
        ...
        public void FetchAndCombineData()
        {
            ...
            var sells = db.tb_sell
                .Where(x => x.sell_cus == customerName)
                .Select(x => new
                {
            ...
            var spends = db.tb_spend_cus
                .Where(x => x.name_cus == customerName)
                .Select(x => new
                {
            ...
            var revs = db.tb_rev_cus
                .Where(x => x.name_cus == customerName)
                .Select(x => new
                {
                    OperationType = "مرتجع عميل",
                    Date = x.date,
            ...
            frm_report_view7 reportForm = new frm_report_view7();
            ...
            string totall_price = tb_Cus.total_price.ToString();
